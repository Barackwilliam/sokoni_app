...
const List<AppCategory> kCategories = [
  ...
  AppCategory(
      ...
      subtitle: 'Salons & beauty care',
      imageUrl:
          'https://images.unsplash.com/photo-1560066984-138daab0473b?w=400'),
  AppCategory(
      id: 'restaurant',
      name: 'Restaurant',
      icon: Icons.restaurant_rounded,
      color: Color(0xFF4CAF50),
      subtitle: 'Delicious food nearby',
      imageUrl:
...
/// Cloudinary settings for image uploads (see lib/services/storage_service.dart
/// for the 3-minute setup guide). REPLACE both values with yours.
class CloudinaryConfig {
  static const String cloudName = 'djzcf2bvp';
  static const String uploadPreset = 'djzcf2bvp';
}
